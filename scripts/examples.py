...
print('SMOFZQA JDFV')
print('DECRIPTED:', vigenere('SMOFZQA JDFV', 'WIDDLE'))
print('OOIY DMEV VN IBWRKAMW BRUWLL')
print('DECRIPTED:', vigenere('OOIY DMEV VN IBWRKAMW BRUWLL', 'SHIFTER'))
print('NLMXQWWN IIZ LZFNF')
print('DECRIPTED:', vigenere('NLMXQWWN IIZ LZFNF', 'WHATEVS'))
...
print('DECRIPTED:', vigenere('YM’KL ECN PPK WFOM UBR KQVXNLK, DCI SIK’U VDA JFTOTA AYQ BWL VVCT "EBTGGB BHWKGZH" HVV: TMEASZFA LOS YCDT PRWKTIYEKGL DBV XQDTYRDGVI', 'CIPHER'))