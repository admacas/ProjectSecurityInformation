...
print('******* VIGENERE EXAMPLES *******')
print('SMOFZQA JDFV')
print('DECRIPTED:', vigenere_dec('SMOFZQA JDFV', 'WIDDLE'))
print('OOIY DMEV VN IBWRKAMW BRUWLL')
print('DECRIPTED:', vigenere_dec('OOIY DMEV VN IBWRKAMW BRUWLL', 'SHIFTER'))
print('NLMXQWWN IIZ LZFNF')
print('DECRIPTED:', vigenere_dec('NLMXQWWN IIZ LZFNF', 'WHATEVS'))
print('YM’KL ECN PPK WFOM UBR KQVXNLK, DCI SIK’U VDA JFTOTA AYQ BWL VVCT "EBTGGB BHWKGZH" HVV: TMEASZFA LOS YCDT PRWKTIYEKGL DBV XQDTYRDGVI')
print('DECRIPTED:', vigenere_dec('YM’KL ECN PPK WFOM UBR KQVXNLK, DCI SIK’U VDA JFTOTA AYQ BWL VVCT "EBTGGB BHWKGZH" HVV: TMEASZFA LOS YCDT PRWKTIYEKGL DBV XQDTYRDGVI', 'CIPHER'))